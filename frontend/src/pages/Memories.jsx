...
import { Plus, MapPin, Calendar, Tag, Image as ImageIcon,
  Edit3, Trash2, Loader2, AlertTriangle } from 'lucide-react';
import { useDispatch, useSelector } from 'react-redux';
import { fetchMemories, toggleAddModal, toggleEditModal } from '../redux/slices/memoriesSlice';
import MemoryForm from '../components/memories/MemoryForm';

// Glass Card Component (reused pattern)
const GlassCard = ({ children, className = "" }) => (
  <div className={`bg-white/10 backdrop-blur-lg rounded-xl p-4 shadow-xl border border-white/10 ${className}`}>
    {children}
  </div>
);
...
export default function Memories() {
  ...
  const { items: memories, status, error, isAddModalOpen, isEditModalOpen, selectedMemory } = 
  ...
  return (
    <div className="p-4 md:p-8 min-h-screen mx-auto my-auto">
        ...
        {memories.length === 0 ? (
          <GlassCard className="text-center py-12">
            ...
            <p className="text-gray-400">
              Start capturing your precious moments by clicking the "Add Memory" button.
            </p>
          </GlassCard>
        ) : (
