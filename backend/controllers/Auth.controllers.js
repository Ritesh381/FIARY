            ...
            shelves: [
                {
                    ...
                    schema: [
                        ...
                        { key: "url", type: "url" },
                        { key: "preview_link", type: "url" },
                        { key: "page_count", type: "number" },
                        { key: "page_read", type: "number" },
                ...
                },
                {
                    ...
                    schema: [
                        { key: "id", type: "text", required: true },
                        { key: "title", type: "text", required: true },
                        { key: "backdrop", type: "photo", required: true },
                        { key: "poster", type: "photo" },
                        { key: "overview", type: "text" },
                        { key: "genre_ids", type: "array", required: true },
                        { key: "release", type: "date", required: true },
                        { key: "user_notes", type: "text" },
